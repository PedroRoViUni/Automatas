...
public class GenerarClase {
  ...
  private static final String ZZ_CMAP_BLOCKS_PACKED_0 =
    "\12\0\4\1\22\0\1\2\31\0\1\3\6\0\32\2"+
    "\6\0\32\2\12\0\1\1\133\0\1\2\7\0\1\2"+
    "\3\0\1\2\5\0\1\2\6\0\1\2\u012d\0\2\1"+
    "\326\0\u0100\1";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    "\0\0\0\4\0\10\0\14\0\10\0\4\0\14\0\4";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    "\1\2\1\3\1\4\1\2\3\0\1\5\4\0\1\6"+
    "\1\0\1\7\1\10";
   ...
   */
  public GenerarClase(java.io.Reader in) {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 3:
            { cont++; 
	lista.add(yytext().replace(" ","_").replace(":","").replace("á","a").replace("é","e").replace("í","i").replace("ó","o").replace("ú","u"));
            }
            // fall through
          case 6: break;
          default:
  ...
  public static void main(String[] argv) {
    if (argv.length == 0) {
      System.out.println("Usage : java GenerarClase [ --encoding <name> ] <inputfile(s)>");
    }
    else {
      int firstFilePos = 0;
      ...
      for (int i = firstFilePos; i < argv.length; i++) {
        GenerarClase scanner = null;
        try {
          java.io.FileInputStream stream = new java.io.FileInputStream(argv[i]);
          java.io.Reader reader = new java.io.InputStreamReader(stream, encodingName);
          scanner = new GenerarClase(reader);
